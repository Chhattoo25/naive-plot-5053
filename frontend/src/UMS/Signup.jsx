...
import { addgoogle, adduserurl } from './server';
import { useParams } from 'react-router-dom'
import axios from 'axios'
import GoogleToggle from './googleToggle';
    ...
    <div>
      ...
      >
        ...
        <ModalContent sx={{width:'500px'}}>
          ...
          <Text textAlign="center" mb='20px'>Create your account</Text>
          ...
          <FormControl>
              <Input type="email" name='email' onChange={(e)=>changevalue(e)} placeholder='Enter Email'  />
            </FormControl>
          <FormControl mt={4}>
              <Input type='password' name='password' onChange={(e)=>changevalue(e)} placeholder='Enter Password' />
            </FormControl>
            
            <Button onClick={(e)=>register(e)} w='100%' bg='black' color='white' mt='20px'>
              SIGN UP
            </Button>

            <Flex> 
              <Button onClick={()=>submitgoogle()} marginTop='40px' colorScheme='teal' variant='ghost'>
                <GoogleToggle />
                {/* <Image
                  borderRadius='full'
                  boxSize='60px'
              ...
              <Button marginTop='40px' colorScheme='teal' variant='ghost'>
                    <Image
                  borderRadius='full'
                  boxSize='50px'
                  mr='50px'
