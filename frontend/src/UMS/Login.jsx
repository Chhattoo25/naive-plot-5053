    ...
    <div>
      ...
      >
        ...
        <ModalContent sx={{width:'500px'}}>
          ...
          <Text textAlign="center" mb='20px'>Log in your account</Text>
          ...
          <FormControl>
              <Input type="email" name="email" placeholder='Enter Email' onChange={(e)=>changevalue(e)} />
            </FormControl>
          <FormControl mt={4}>
              <Input type='password' name="password" placeholder='Enter Password' onChange={(e)=>changevalue(e)} />
            </FormControl>
            <Text textAlign='center' mt='9px' >Forgot Password?</Text>
            <Button onClick={(e)=>login(e)} w='100%' bg='black' color='white' mt='20px'>
              Login
            </Button>
